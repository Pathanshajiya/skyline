export const navigation = {
      ...
      AboutUs: {
        ...
        name: 'About Us',
        content: `
          <p>Welcome to our online store! We are dedicated to providing the best shopping experience for our customers.</p>
          <p>Our mission is to offer high-quality products and exceptional customer service.</p>
          <p>Feel free to explore our website and discover a wide range of clothing, accessories, and brands.</p>
        `,
      },
    };
